        ...
        <div class="card card-border bg-white shadow-sm">
            <div class="card-body p-4">
                <h5 class="mb-4 fw-bold" style="color:var(--admin-text);">
                    <i class="fa-solid fa-pen-to-square text-primary me-2"></i>Update Coupon Details
                </h5>
                ...
                <form action="{{ route('admin.coupons.update', $coupon->id) }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control text-uppercase @error('code') is-invalid @enderror" id="code" name="code" value="{{ old('code', $coupon->code) }}" required>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <select class="form-select @error('type') is-invalid @enderror" id="type" name="type" required>
                                ...
                                <option value="fixed" {{ old('type', $coupon->type) == 'fixed' ? 'selected' : '' }}>Flat Amount ($)</option>
                            </select>
                        ...
                        <div class="col-md-6 mt-3 mt-md-0">
                            ...
                            <input type="number" step="0.01" class="form-control @error('value') is-invalid @enderror" id="value" name="value" value="{{ old('value', (float)$coupon->value) }}" required>
